...
{
    protected string $table = 'tb_fornecedor_fornecimento';

    public function insert(array $data)
    {
        try {
            $connect = Connect::connect();
            $prepare = $connect->prepare("insert into $this->table(quantidade, fornecedor, estoque) 
                                        values( 
                                            :stock,
                                            :supplier,
                                            :productStock
            ...
            return $prepare->execute([
                ...
                ':productStock' => $data['idProductSizeStock']
            ]);
